...
CCC
    ...
    5)
        ...
        ;;
    6)
        create_res_1 2560x1600 2048x1280 1920x1200 1760x1100 1680x1050 1600x1000 1440x900 1360x850 1280x800 1120x700 960x600
        create_res_2 1600x1000 1280x800 1280x720 960x600 960x600 640x400
        create_res_3 1280x800 840x472 800x450 720x405 640x360 576x324 512x288 420x234 400x225 320x180
        create_res_4 1680x945 1440x810 1280x720 1024x576 960x540 840x472 800x450 640x360
        ;;
    7)
        custom_res
