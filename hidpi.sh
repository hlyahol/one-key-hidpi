...
CCC
    ...
    6)
        ...
        create_res_2 2560x1600 1600x1000 1280x800 1280x720 960x600 960x540 640x360
        create_res_3 2560x1600 1600x1000 1280x800 840x472 800x450 720x405 640x360 576x324 512x288 420x234 400x225 320x180
        create_res_4 2560x1600 1600x1000 1280x800 1680x945 1440x810 1280x720 1024x576 960x540 840x472 800x450 640x360
        ;;
    7)
        custom_res
